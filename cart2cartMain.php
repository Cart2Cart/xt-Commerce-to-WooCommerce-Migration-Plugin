 ...
 */
/*
Plugin Name: Cart2Cart: Magento to WooCommerce Migration Module
...
function cart2cart_config(){
	...
	$sourceCartName = 'xt:Commerce';
	$referertext = 'Cart2Cart: '. $sourceCartName  . ' to '. $cartName  . ' Module';
	$sourceCartLogo = 'http://www.shopping-cart-migration.com/images/stories/'.strtolower(str_replace(':','',trim($sourceCartName))).'.gif';
